    ...
    <section className="max-w-7xl mx-auto px-4 tablet:px-8 py-16 tablet:py-24">
      <div className="grid tablet:grid-cols-[1.05fr_0.95fr] gap-10 tablet:gap-16 items-center">
        <Reveal className="max-w-xl">
          <EyebrowLabel>{t.whyPartner.eyebrow}</EyebrowLabel>
          ...
          <div className="mt-6 space-y-4 text-body-lg text-text-secondary">
            <p>{t.whyPartner.paragraph1}</p>
            <p>{t.whyPartner.paragraph2}</p>
          </div>
        </Reveal>

        <Reveal delay={1}>
          <div className="group relative aspect-[4/3.1] rounded-xl overflow-hidden shadow-lg border border-border">
            <Image
