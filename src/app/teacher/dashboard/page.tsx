  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between flex-wrap gap-3">
        <div>
          <h1 className="text-h1 font-bold">Welcome, {teacherName || "Teacher"}</h1>
          <p className="text-small text-text-muted mt-1">Your classes and subjects for this term</p>
        </div>
      ...
      <div className="grid grid-cols-1 tablet:grid-cols-2 gap-4">
        {assignedClasses.map((cls) => (
          <Card key={cls.class_id} variant="bordered" className="shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-small text-text-muted mb-4">
              {cls.subject_count} subject{cls.subject_count !== 1 ? "s" : ""} assigned
            </p>
            <button
        ...
        {assignedClasses.length === 0 && (
          <Card variant="bordered" className="col-span-2 text-center py-10">
            ...
            <p className="text-caption text-text-muted mt-1">Contact your School Admin to get assigned.</p>
          </Card>
        )}
      </div>
    </div>
