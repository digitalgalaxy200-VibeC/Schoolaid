  ...
  return (
    <Card variant="default" className="shadow-sm overflow-hidden">
      ...
      {c.subjects.length > 0 && (
        <div className="border-t border-border">
          ...
          <button
            ...
            className="w-full flex items-center justify-between px-5 py-3 min-h-[44px] text-left hover:bg-surface-hover transition-colors"
          >
      ...
      <div className="border-t border-border grid grid-cols-2">
        <button
          onClick={(e) => { e.stopPropagation(); router.push(`/teacher/scores?class=${c.id}`); }}
          className="flex items-center justify-center gap-1.5 min-h-[44px] text-caption font-semibold text-primary hover:bg-primary/5 transition-colors border-r border-border"
        >
        ...
        <button
          ...
          className="flex items-center justify-center gap-1.5 min-h-[44px] text-caption font-semibold text-accent hover:bg-accent/5 transition-colors"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
