    ...
    <div className="space-y-6">
      ...
      {tab === "all" && (
        <>
          ...
          <Card variant="default" className="shadow-sm"><details><summary className="text-small font-semibold text-text-secondary p-3 cursor-pointer">Bulk Add Subjects</summary><div className="p-3 space-y-3"><p className="text-caption text-text-muted">One per line: Name, Code</p><textarea value={bulkText} onChange={e=>setBulkText(e.target.value)} rows={6} className="w-full px-4 py-3 bg-surface border border-border rounded-lg text-body focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors" placeholder="Mathematics, MATH&#10;English, ENG"/><Button onClick={handleBulk}>Bulk Create</Button></div></details></Card>
